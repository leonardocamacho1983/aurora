...
export async function POST(request: Request) {
  ...
  await db.execute(sql`
    ...
    values (
      ...
      ${action === "shown" ? nowIso : null}::timestamp with time zone,
      ${action === "answered" ? nowIso : null}::timestamp with time zone,
      ${action === "skipped" ? nowIso : null}::timestamp with time zone,
