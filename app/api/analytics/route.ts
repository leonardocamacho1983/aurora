...
const ALLOWED_EVENTS = new Set([
  ...
  "product_diary_save_prompt_shown",
  "product_diary_silent_save_requested",
  "product_diary_silent_save_succeeded",
  "product_diary_silent_save_failed",
  "product_diary_reflection_requested",
  "product_reflection_routed",
