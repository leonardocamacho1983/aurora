...
const productUISystem = [
  ...
  ["Responsive Lab", "Validação por ambiente", "Mobile, tablet e desktop como composições específicas, com cenário controlável."],
...
const components = [
  ...
  ["FlipCard", "front / back / expanded / flipped", "Texto longo expande antes do flip para a devolutiva."],
...
const patterns = [
  ...
  ["Responsive Screen Lab", "Patterns aparecem como tela inteira em mobile, tablet e desktop; não é só resize."],
];
  ...
  return (
    <header className={styles.header}>
      ...
      <nav className={styles.nav} aria-label="Design system">
        ...
        <a href="#product-ui-system">Sistema</a>
        <a href="#biblioteca-componentes">Biblioteca de Componentes</a>
        <a href="#orb">Orb</a>
...
function ProductUISystem() {
  return (
    <section className={styles.section} id="product-ui-system">
      <SectionHeader
        kicker="Product UI System"
        title="A tela nasce da camada certa."
        copy="Aurora usa design atômico de forma pragmática: tokens, primitivos, componentes de produto, padrões e receitas de tela."
      />
      <div className={styles.systemGrid}>
        {productUISystem.map(([layer, role, rule]) => (
          <article className={styles.systemCard} key={layer}>
            <span>{layer}</span>
            <h3>{role}</h3>
            <p>{rule}</p>
          </article>
...
function ComponentInventory() {
  return (
    <section className={styles.section} id="biblioteca-componentes">
      <SectionHeader
        kicker="Biblioteca de Componentes"
        title="Peças prontas para montar telas."
        copy="Esta aba concentra só componentes: camada, nome, variantes e regra de uso. Fundamentos, padrões e exemplos ficam fora daqui."
      />
      <div className={styles.componentList}>
        {componentInventory.map(([layer, name, variants, note]) => (
      ...
      <div className={styles.shell}>
        ...
        <section className={styles.section} id="padroes">
          <SectionHeader
            ...
            copy="Landing, produto e operação usam a mesma identidade, mas não a mesma densidade visual. Mobile, tablet e desktop não são versões reduzidas da mesma tela."
          />
