    ...
    <main className={styles.stage}>
      ...
      <header className={styles.topnav}>
        <div className={styles.topnavInner}>
          ...
          <nav className={styles.navLinks} aria-label="Navegação principal">
            ...
            <Link href="/account" aria-current="page">Perfil</Link>
          </nav>
        </div>
      </header>
      ...
      <div className={styles.shell}>
        ...
        <section className={`${styles.card} ${styles.block}`} aria-label="Presença">
          ...
          <p className={styles.presenceLead}>Alguns dias você falou, outros não. Cada um no seu tempo — nada aqui é para completar.</p>
          <div
