...
const requiredFiles = [
  ...
  "docs/personas-publico-alvo-usp-comunicacao.md",
  ...
  "app/design-system/posicionamento/page.tsx",
...
const hubPhrases = [
  "Aurora Product System",
  "Tudo que agentes, designers, product managers e developers precisam consultar",
  "Design System",
  "Público-alvo e Posicionamento",
  "Separe execução visual de estratégia de produto.",
  "Antes de criar uma tela, escolha um pattern existente",
  "Antes de escrever copy, confira posicionamento",
  "Fundamentos",
  "Biblioteca de Componentes",
  "Patterns de Tela",
  "Referência Completa",
  "A entrega precisa ser fiel à Aurora antes de ser bonita.",
  "Fase 4",
];

const positioningPhrases = [
  "Público-alvo e Posicionamento",
  "A estratégia que mantém a Aurora fiel a si mesma.",
  "Aurora é um diário por voz para organizar o que você sente, pensa e quer colocar em prática",
  "Aurora transforma o que você sente, pensa e quer colocar em prática em clareza, padrões e próximos passos",
  "O que a Aurora é e o que ela não pode parecer.",
  "Um chat generalista",
  "Terapia, diagnóstico, tratamento ou emergência",
  "Como explicar sem virar terapia, chat ou produtividade.",
];
...
if (existsSync(path.join(root, "docs/agent-guardrails/design-system.md"))) {
  ...
  for (const phrase of ["Fraunces", "Inter", "prefers-reduced-motion", "/design-system", "/design-system/posicionamento", "/design-system/biblioteca", "/design-system/referencia", "personas-publico-alvo-usp-comunicacao.md", "reference.md", "component-inventory.md", "ui-ux-creation-brief.md"]) {
...
if (existsSync(path.join(root, "app/design-system/posicionamento/page.tsx"))) {
  const positioning = read("app/design-system/posicionamento/page.tsx");
  assertEvery("app/design-system/posicionamento/page.tsx", positioning, positioningPhrases);
}

if (existsSync(path.join(root, "docs/personas-publico-alvo-usp-comunicacao.md"))) {
  const positioningDoc = read("docs/personas-publico-alvo-usp-comunicacao.md");
  assertEvery("docs/personas-publico-alvo-usp-comunicacao.md", positioningDoc, [
    "Aurora é um diário por voz para organizar o que você sente, pensa e quer colocar em prática",
    "Aurora transforma o que você sente, pensa e quer colocar em prática em clareza, padrões e próximos passos",
    "A Aurora é para pessoas que precisam se escutar",
    "Não é terapia. Não é chat genérico. Não é lista de tarefas.",
  ]);
}
