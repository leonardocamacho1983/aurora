...
export function CtaFinal({ orbGlow = 1 }: { orbGlow?: number }) {
  return (
    <section style={{ borderTop: "1px solid rgba(255,255,255,.06)", position: "relative", overflow: "hidden", background: "radial-gradient(ellipse 100% 90% at 50% 120%, #1a1330 0%, #0A0814 62%)" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1080, margin: "0 auto", padding: "clamp(80px,11vw,110px) clamp(20px,5vw,32px) clamp(140px,18vw,200px)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
