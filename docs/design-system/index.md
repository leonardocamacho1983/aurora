...
- oferecer um hub consultável em `/design-system`, com páginas focadas por função;
...
A rota protegida `/design-system` funciona como hub curto. A cobertura completa fica dividida em páginas focadas:

- `/design-system`: entrada por tarefa, regras críticas e próximo encaixe.
...
- A experiência consultável vive em `/design-system`, `/design-system/fundamentos`, `/design-system/biblioteca`, `/design-system/referencia` e `/design-system/roadmap`; todas exigem `DESIGN_SYSTEM_ADMIN_TOKEN`.
