...
11. A rota protegida `/design-system/biblioteca`
12. A rota protegida `/design-system/patterns`
13. A rota protegida `/design-system/referencia`
...
- `/design-system`: hub, regras críticas e próximo encaixe.
